    ...
    <div className={`bg-white border-r border-border h-full flex flex-col transition-all duration-300 ${
      ...
      <div className="p-4 border-b border-border">
        <div className="flex items-center space-x-3">
          ...
          {!isCollapsed && (
            <div>
              <h2 className="text-lg font-bold text-accent">QuizMaker</h2>
              <p className="text-xs text-muted">Online Exams</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="p-4 border-t border-border">
          ...
          {!isCollapsed && (
            <>
              <button
                ...
                className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-muted hover:bg-secondary hover:text-accent rounded-lg transition-colors"
              >
        ...
        {onToggle && (
          <button
            onClick={onToggle}
            className="w-full mt-4 flex items-center justify-center px-3 py-2 text-sm text-muted hover:bg-secondary hover:text-accent rounded-lg transition-colors"
          >
            <svg 
